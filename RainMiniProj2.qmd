...
```{r}
robotstxt::paths_allowed("https://stardewvalleywiki.com/Fish")

session <- bow("https://stardewvalleywiki.com/Fish", force = TRUE)

result_fish <- scrape(session) |>
  html_nodes("nth-child(43)") |> 
  html_table(header = TRUE, fill = TRUE)
