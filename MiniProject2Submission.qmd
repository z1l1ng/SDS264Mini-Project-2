...
#clean up the variable names so that it is ready for the row bind. make sure the category is all mineral, and the sub_category is correct
...
```{r}
stardew_items <- bind_rows(crops_prices, 
