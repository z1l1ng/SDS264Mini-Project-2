...
# function for creating a tibble of prices for a given fish, for one of the 4 different tables they have for the fish, this takes care of almost all of our fish
...
# Loading in the fish we know that are tr:nth-child(14) in the html
fishfor14 <- readRDS("~/SDS264/Class Files/MiniProject2/fishfor14.RDS")
fishfor14

# Loading in the fish we know that are tr:nth-child(15) in the html
fishfor15 <- readRDS("~/SDS264/Class Files/MiniProject2/fishfor15.RDS")
fishfor15

# Loading in the fish we know that are tr:nth-child(10) in the html
